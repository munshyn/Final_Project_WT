...
echo '</script>';
?>
<title>Updating Manager Data</title><head>
...
<body>
	...
	<div id="form-title">
		<p id="p2">Update Manager Data Form</p>
	</div>
	...
	<form name="form1" method="post" action="update_manager.php" onsubmit="return validate()">
	<table class="form">
		<tr>
