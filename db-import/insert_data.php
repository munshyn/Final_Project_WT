...
$User1 = "INSERT INTO users(email, password, level, name) VALUES ('mamu@gmail.com','mamu1',1, 'Mahmud')";
$User2 = "INSERT INTO users(email, password, level, name) VALUES ('luqman@gmail.com','luqman2',2, 'Luqman')";
$User7 = "INSERT INTO users(email, password, level, name) VALUES ('mejak@gmail.com','mejak2',2, 'Amjad')";
$User3 = "INSERT INTO users(email, password, level, name) VALUES ('mirwanwan@gmail.com','mirwanwan3',3, 'Amir')";
$User8 = "INSERT INTO users(email, password, level, name) VALUES ('syedmirin@gmail.com','syedmirin3',3, 'Syed')";
